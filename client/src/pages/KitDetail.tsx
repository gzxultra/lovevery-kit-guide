 ...
 * - Stacked toy card layout on mobile (image on top)
 * - Touch-friendly expand/collapse buttons (min 44px)
 * - Proper text sizing and spacing for small screens
 * - Swipeable prev/next kit navigation
 */

import { getKitById, kits } from "@/data/kits";
...
function ToyCard({
  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl border border-[#E8DFD3] overflow-hidden hover:shadow-lg hover:shadow-[#3D3229]/5 transition-shadow">
      {/* Toy Header with Image */}
      <div className="p-4 sm:p-6 pb-3 sm:pb-4">
        <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-5">
          {/* Toy Image - full width on mobile, fixed size on desktop */}
          {toyImage ? (
            ...
            <div
              className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0 text-lg sm:text-xl font-['DM_Serif_Display'] text-white"
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 relative z-10">
          ...
          <div className="grid md:grid-cols-[1fr_auto] gap-6 sm:gap-8 items-start">
            ...
            {/* Kit Hero Image from Lovevery - desktop only (mobile shown above) */}
            {heroImage && (
